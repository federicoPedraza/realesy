...
import { MapPin, Eye, Heart, Share2, ChevronLeft, ChevronRight, Loader2 } from "lucide-react"
...
export const PropertyCard: React.FC<PropertyCardProps> = ({
  ...
  // Check if we're still loading multimedia data
  const isLoading = multimedia === undefined
